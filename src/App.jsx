  ...
  try {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            const apiKey = "AIzaSyCFlhCcqLMBxK5ckKcO30WjftmT1w_uj8Q"; // Canvas will provide this in runtime for gemini-2.0-flash
...
const ImageGenerator = () => {
    ...
    const generateImage = async () => {
        ...
        try {
            ...
            const apiKey = "AIzaSyCFlhCcqLMBxK5ckKcO30WjftmT1w_uj8Q"; // Canvas will provide this in runtime for imagen-3.0-generate-002
